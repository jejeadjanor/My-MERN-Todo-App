...
class UpdateTask extends Component {
    ...
    componentDidMount(){
      axios.get('http://localhost:8000/todolist/' + this.props.match.params.id)
        .then(response => {
            this.setState({
                todo_task: response.data.todo_task,
                todo_person: response.data.todo_person,
                todo_timeplace: response.data.todo_timeplace,
...
onSubmit(e){
    ...
    axios.post('http://localhost:8000/todolist/update/'+ this.props.match.params.id, obj)
            ...
            <div>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <br/>
                        <div className="form-group">
                            <input type="submit" value="Update Task" className="btn btn-danger"/>
                        </div>
                    </div>
